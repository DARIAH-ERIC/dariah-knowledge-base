...
function HeroSection(): ReactNode {
	...
	return (
		<section className="layout-subgrid relative gap-y-10 bg-fill-weaker py-16 xs:py-24">
			<div className="grid max-w-screen-sm gap-y-6">
				...
				<p className="text-balance font-heading text-small text-text-weak xs:text-heading-4">
					{t("lead-in")}
				</p>
			</div>
		</section>
...
function FeaturesSection(): ReactNode {
	...
	return (
		<section className="layout-subgrid relative gap-y-12 border-t border-stroke-weak py-16 xs:py-24">
			<header className="grid max-w-screen-sm gap-y-4">
				<h2 className="text-balance font-heading text-heading-2 font-strong text-text-strong">
					Features
				</h2>
				<p className="text-balance font-heading text-heading-4 text-text-weak">
