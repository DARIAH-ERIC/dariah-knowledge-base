...
export function AccountMenuContent(props: AccountMenuContentProps): ReactNode {
	...
	return (
		<MenuTrigger>
			...
			<Popover className="rounded-2 border border-stroke-weak bg-background-overlay py-2 shadow-overlay">
				...
				<Menu>
					<Separator className="my-1 border-t border-stroke-weak" />
					<MenuItem
						className={cn(
							"flex gap-x-3 px-4 py-3 text-small text-text-strong",
